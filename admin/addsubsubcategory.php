...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST["name"])) {
     ...
     $name = $_POST["name"];
		...
		$sql = mysql_query("INSERT INTO `sub_sub_category`(`name`, `sub_category_id`) 
							VALUES (		
									'$name',
									'$sub_category'
									)");
		...
		if($sql){    
			ob_start();
			header("location: addsubsubcategory.php"); 
			ob_end_flush();
			exit();
	    }else{
			$msg = "Unsuccessfull";
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Dashboard - Add Sub Sub Category
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <div class="row">
                    ...
                    <form class="col-md-12"  name="name" action='addsubsubcategory.php' method='post' enctype="multipart/form-data">	
